...
#include "merge-sort-exchange.cpp"
...
{
    merge_sort_exchange(empty_list, 0, 0);
}

BOOST_AUTO_TEST_CASE(normal)
{
    merge_sort_exchange(normal_list, 0, NORMAL_SIZE);
...
{
    merge_sort_exchange(normal_list, 0, NORMAL_SIZE, false);
    for (int i = 0; i < NORMAL_SIZE; ++i) {
...
BOOST_AUTO_TEST_CASE(random)
{
    ...
    merge_sort_exchange(random_list, 0, RANDOM_SIZE);
